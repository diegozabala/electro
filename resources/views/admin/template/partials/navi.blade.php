...
<div class="container">
    ...
    <nav class="navbar navbar-default">
        <div class="navbar-header">
            ...
            <a class="navbar-brand active" href="{{url('admin/prestamos')}}">Préstamos Facultad de Ingeniería</a>
        </div>
                    ...
                    <ul class="dropdown-menu mega-dropdown-menu row">
                                ...
                                <div id="myCarousel" class="carousel slide" data-ride="carousel">
                                    <div class="carousel-inner">
                                        <div class="item active">
                                            ...
                                            ?>
                                            <a href="#"><img src="{{$dire}}" class="img-responsive" alt="product1"></a>
                                            <li class="divider"></li>
                        ...
                        <li class="col-sm-4">
                            ...
                            <ul>
                                ...
                                <li><a href="{{url('admin/prestamos/create')}}">Crear Prestamos</a></li>
